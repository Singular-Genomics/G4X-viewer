...
To begin exploring your data, first load your sample into the viewer. Each G4X sample output contains a `/g4x_viewer/` directory, which is described in detail in the [G4X Viewer output documentation](https://docs.singulargenomics.com/g4x_data/output_files/g4x_viewer/).
...
## [transcript layer](./transcript.md)
...
## [segmentation layer](./segmentation.md)
