...
export const TranscriptLayerWarningModal = ({ isOpen, onContinue, handleClose }: TranscriptLayerWarningModalProps) => {
      ...
      <Box sx={sx.modalContainer}>
        ...
        <Box sx={sx.modalContentWrapper}>
          <Typography sx={sx.modalContentText}>
            ...
            <br />
            These operations demand significant computational resources and might cause the application to crash.
            Perform these operations if:
          </Typography>
          <Typography
            component={'span'}
...
const styles = (theme: Theme) => ({
  ...
  continueButton: {
    background: 'linear-gradient(90deg, rgba(251,0,0,1) 0%, rgba(135,0,0,1) 100%)',
    color: theme.palette.gx.primary.white
  },
  cancelButton: {
